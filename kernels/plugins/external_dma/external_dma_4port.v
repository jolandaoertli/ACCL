...
(
  ...
  external_dma_bd ext_dma_bd(
        ...
        .m_axi_3_araddr(m_axi_3_araddr),
        .m_axi_3_arburst(m_axi_3_arburst),
        .m_axi_3_arcache(m_axi_3_arcache),
        .m_axi_3_arlen(m_axi_3_arlen),
        .m_axi_3_arprot(m_axi_3_arprot),
        .m_axi_3_arready(m_axi_3_arready),
        .m_axi_3_arsize(m_axi_3_arsize),
        .m_axi_3_aruser(m_axi_3_aruser),
        .m_axi_3_arvalid(m_axi_3_arvalid),
        .m_axi_3_awaddr(m_axi_3_awaddr),
        .m_axi_3_awburst(m_axi_3_awburst),
        .m_axi_3_awcache(m_axi_3_awcache),
        .m_axi_3_awlen(m_axi_3_awlen),
        .m_axi_3_awprot(m_axi_3_awprot),
        .m_axi_3_awready(m_axi_3_awready),
        .m_axi_3_awsize(m_axi_3_awsize),
        .m_axi_3_awuser(m_axi_3_awuser),
        .m_axi_3_awvalid(m_axi_3_awvalid),
        .m_axi_3_bready(m_axi_3_bready),
        .m_axi_3_bresp(m_axi_3_bresp),
        .m_axi_3_bvalid(m_axi_3_bvalid),
        .m_axi_3_rdata(m_axi_3_rdata),
        .m_axi_3_rlast(m_axi_3_rlast),
        .m_axi_3_rready(m_axi_3_rready),
        .m_axi_3_rresp(m_axi_3_rresp),
        .m_axi_3_rvalid(m_axi_3_rvalid),
        .m_axi_3_wdata(m_axi_3_wdata),
        .m_axi_3_wlast(m_axi_3_wlast),
        .m_axi_3_wready(m_axi_3_wready),
        .m_axi_3_wstrb(m_axi_3_wstrb),
        .m_axi_3_wvalid(m_axi_3_wvalid),
